package com.lkm.sportsTeamManagement;
...
public class App {
	...
	public void removePlayer(String playerName) {
		if (players.remove(playerName)) {
			System.out.println(
					playerName + " has been removed from the team.");
		} else {
	...
	public static void main(String[] args) {
		...
		while (!exit) {
			...
			case 3:
				...
				boolean isPlayerInTeam = teamManager
						.checkPlayer(checkPlayerName);
				if (isPlayerInTeam) {
					System.out
							.println(checkPlayerName + " is in the team.");
				} else {
					System.out.println(
							checkPlayerName + " is not in the team.");
				}
				break;
			case 4:
